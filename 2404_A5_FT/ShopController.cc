    ...
    while (1) {
        ...
        if (choice == 1) {
            ...
            if (cust != 0) {
              ...
              //Check if one of the accepted vehicle types was entered
              if (type == 1) { //Car selected
              ...
              } else if(type == 3) { //Motorcycle selected
                string make, model, colour;
                int year, milage;
                bool sidecar;
...
void ShopController::initShop() {
    ...
    newVehicle = factory.create("Ford", "F150", "Black", 2017, 1000, 3); //truck
    (*newCustomer) += newVehicle;
    ...
    newCustomer = new Customer("Ethan", "Esser", "245 Rideau St.",
                                        "(613)234-9677");
    newVehicle = factory.create("Mack", "Granite", "Red", 2000, 500000, 8); //truck
    (*newCustomer) += newVehicle;
    ...
    (*newCustomer) += newVehicle;
    newVehicle = factory.create("Kawasaki", "Z650", "Grey", 2014, 5000, false); //Motorcycle
    (*newCustomer) += newVehicle;
    newVehicle = factory.create("Toyota", "Rav4", "Gold", 2015, 20000);
    (*newCustomer) += newVehicle;
    newVehicle = factory.create("Toyota", "Prius", "Blue", 2017, 10000);
    (*newCustomer) += newVehicle;
    newVehicle = factory.create("Kawasaki", "Ninja", "Blue", 2018, 100, false); //Motorcycle
    (*newCustomer) += newVehicle;
    mechanicShop += newCustomer;
    ...
    newCustomer = new Customer("Victor", "Vanvalkenburg", "425 O'Connor St.",
                                        "(613)432-7622");
    newVehicle = factory.create("Harley", "Touring", "Black", 2006, 8000, true); //Motorcycle
    (*newCustomer) += newVehicle;
